/*
  NOTE: REMEMBER TO CHANGE GEONAME TO STATE (for dataset object)!!!
 */
function drawCharts (mapSource, dataSource, mapEl, graphEl, brushEl) {
...
drawCharts ('USA.json', 'per_capita_personal_income.csv', "#map", "#line-container", "#brush-container");